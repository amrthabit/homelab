      ...
      <table class="w-full">
        <thead class="bg-[#1c2128] text-xs uppercase tracking-wide text-[var(--color-muted)]">
          <tr>
            ...
            <th class="px-3 py-2 text-left hidden sm:table-cell">band</th>
            ...
            {(s) => (
              <tr class={s.enabled ? "" : "opacity-50"}>
                <td class="px-3 py-2 truncate">
                  {s.ssid}
                  <span class="text-xs text-[var(--color-muted)] ml-2 sm:hidden">{s.band}</span>
                </td>
                <td class="px-3 py-2 font-mono text-xs hidden sm:table-cell">{s.band}</td>
